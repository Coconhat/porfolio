...
const BentoCard = ({
  ...
  >
    ...
    <div
      className={cn(
        "pointer-events-none absolute bottom-0.5 flex w-full transform-gpu flex-row items-center p-4 opacity-0 transition-all duration-300 group-hover:translate-y-0 group-hover:opacity-100 ",
      )}
    >
